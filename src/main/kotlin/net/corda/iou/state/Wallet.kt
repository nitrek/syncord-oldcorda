...
data class Wallet(
        val cashCCP: Party,   //Transfer Agent
        //val fundManager: Party,  //FundManager
        val investor: Party,     //Me the node that  doing the transaction.
        var availableBalance:Float,
        var blockedBalance:Float,
        val date :String,
        val currency: String,
    ...
    override val participants: List<AbstractParty> get() = listOf(cashCCP, investor)

    override val contract get() = IOUContract()

    fun blockMoneyAvl(MoneyUsed: Float) = copy(availableBalance =(availableBalance - MoneyUsed))
    fun blockMoneyBlock(MoneyUsed: Float) = copy(blockedBalance   = (blockedBalance + MoneyUsed))
    fun removeblockMoney(MoneyUsed: Float) = copy(blockedBalance   = (blockedBalance - MoneyUsed))
    fun addMoney(MoneyAdded: Float) = copy(availableBalance =(availableBalance + MoneyAdded))
